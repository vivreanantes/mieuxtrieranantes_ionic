var _advicesDatas = [{
		...
		"descr": "Les bouchons de liège sont recyclables mais ne sont pas recyclés. Ils sont récupérés par l'association 'Action Cancer 44' (20 tonnes de bouchons de liège récoltés en 2012). Le dépôt s'effectue chez une bénévole au 52 Rue du Château d'Eau à La Chapelle sur Erdre.",
		...
		"descr": "L'éco-participation (ou éco-contribution), affichée sur le ticket de caisse, est ajouté au prix de vente des appareils électriques ou électroniques, pour compenser le coût de la collecte et du traitement. Il est reversé aux organismes réalisant ces tâches (Eco-systèmes, Ecologic, ERP, et Récylum).",
		"descr_en": "Eco-participation (or eco-contribution), displayed on the receipt, is added to the selling price of electrical and electronic appliances, to offset the cost of collection and treatment. It is donated to organizations performing these tasks (Eco-systems, Ecologic, ERP, and Récylum)."
	}, {
		...
		"nom_en": "Stores that sell them recover: printer cartridges, batteries, energy saving light bulbs, neon",
		...
		"nom": "Produit toxique",
		"nom_en": "Toxicant",
		"descr": "Les produits toxiques ne doivent pas être mis avec les ordures ménagères. Ils doivent être déposés dans les déchèteries.",
		"descr_en": "Toxic products should not be placed with household waste. They must be deposited in the waste collection centers."
	}, {
		"code": "cons_lerelais",
		...
		"descr": "Les utilisateurs de Nespresso peuvent rapporter les capsules usagées officielles de la marque en magasin, en livraison à domicile ou aux points de collecte officiels 'Nespresso'. La marque informe qu'elle refond l'aluminium. Il y a environ 40 points de collecte officiels sur Nantes.<br/>La marque constate que seulement '20 % des clients rapportent leurs capsules usagées'. C'est pourquoi, en partenariat avec le 'projet métal' (Club de l'Emballage Léger en Aluminium et en Acier, Eco-Emballages, Association des Maires de France), elle verse 300 euros aux collectivités qui traitent spécifiquement les petits emballages en aluminium (barquettes, opercules, bouchons, couvercles, papier aluminium).",
		"descr_en": "Nespresso users can report official used capsules of the brand in-store, home delivery or at official collection points 'Nespresso'. The mark informs that it recasts aluminum. There are about 40 official collection points Nantes. <br/> The brand finds that only '20% of customers return their used capsules'. Therefore, in partnership with the metal project '(Club Packaging Lightweight Aluminum and Steel, Eco-Packaging, Association of Mayors of France), it pays 300 euros for communities dealing specifically in small packages aluminum (trays, lids, stoppers, lids, aluminum foil)."
	}, {
		...
		"code": "cons_decheteriequartheure",
