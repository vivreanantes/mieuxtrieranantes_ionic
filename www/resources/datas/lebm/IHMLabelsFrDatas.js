var _ihmLabelsFrDatas = {
	...
	"jhabite_cclernee": "Communauté de Communes de l'Ernée",
	"jhabite_ccbocage": "Communauté de Communes Bocage Mayennais",
	"nom_translated": "{{nom}}",
	"descr_translated": "{{descr}}",
	"resume_translated": "{{resume}}",
	"type_translated": "{{type}}",
	"categorie": "Catégorie",
	"modco_bacbleuextension,modco_bacjauneextension": "Communauté de Communes de l'Ernée : extension de tri (tous plastiques autorisés)",
	"modco_bacblenormal,modco_bacjaunnormal": "Communauté de Communes Bocage Mayennais : tri classique",
	"objet": "Objet",
