var _collectModsDatas = [
   ...
   },
   {
      ...
      "modesCollecte":"false",
      "descr":"On peut mettre : cartons, cartonnettes, enveloppes, feuilles, journaux, magazines, briques, <B>tous les types de plastique</B> (bouteilles eau soda huile, bouchons, flacons, pots de yaourt, pots de crème fraîche, barquettes, films plastique)</B>,  barquettes aluminium, canettes, boîtes de conserves, bombes aérosols.<BR/>Voir <I><A HREF='fich:fiche_bacjaune'>fiche 'Bacs jaunes et bleus'</A></I> .",
      "descr_en":"You can put <BR/>: cartons, cardboards, envelopes, sheets, newspapers, magazines, bricks, <B> all types of plastics </b> (soda water bottles oil, corks, bottles, yogurt cups, cream jars, trays, plastic films) </b>, aluminum trays, cans, tins, aerosols. <BR/> See <I> <A HREF='fich:fiche_bacjaune'> sheet 'yellow bins and blue' </A> </ I>.",
   ...
   },
   {
      ...
      "modesCollecte":"false",
      "descr":"On peut mettre : cartons, cartonnettes, enveloppes, feuilles, journaux, magazines, briques, les bouteilles eau soda huile, bouchons, flacons,  barquettes aluminium, canettes, boîtes de conserves, bombes aérosols.<BR/>Voir <I><A HREF='fich:fiche_bacjaune'>fiche 'Bacs jaunes et bleus'</A></I>.",
      "descr_en":"You can put <BR/>: cartons, cardboards, envelopes, sheets, newspapers, magazines, bricks, water bottles soda oil, corks, bottles, aluminum trays, cans, tins, aerosols. <BR/> bombs See <I> <A HREF='fich:fiche_bacjaune'> sheet 'blue and yellow Bacs' </A> </ I>.",
      "cons":"cons_pasuniquementbouteilleflacon,cons_bac_casse,cons_collectes_bacs",
      "icone":"modco",
      "image":"bac_jaune_en_cours_mini.png",
      "mots_cles":"bacs,jaunes",
   ...
   },
   {
      ...
      "modesCollecte":"false",
      "descr":"On met dans les sacs bleus les <B>déchets ménagers non recyclés</B>.",
   ...
   },
   {
      ...
      "modesCollecte":"false",
      "descr":"<UL>On peut mettre : cartons, cartonnettes, enveloppes, feuilles, journaux, magazines, prospectus, boîtes à œuf en carton, briques, bouteilles avec bouchons (eau, soda, huile), flacons, barquettes aluminium, canettes, boîtes de conserves, bombes aérosols.<BR/>Voir <I><A HREF='fich:fiche_sacjaune'>fiche 'Sacs jaunes et bleus'</A></I> .",
      "descr_en":"<UL> You can put: cartons, cardboards, envelopes, sheets, newspapers, magazines, brochures, egg boxes cardboard, bricks, bottles with caps (water, soda, oil), bottles, aluminum trays, cans, tins, aerosols. <BR/> See <I> <A HREF='fich:fiche_sacjaune'> sheet 'Bags yellow and blue '</A> </ I>.",
   ...
   },
   {
      ...
      "modesCollecte":"true",
      "descr":"Plusieurs organismes ('Alis 44' à Nantes, 'Actif Ouest' à Saint-Herblain, 'Nâga' à Rezé) récupèrent les anciens apareils informatiques.",
      "descr_en":"Several organizations (Alis 44 'in Nantes, western Active' in Saint-Herblain, 'Naga' in Rezé) recover old computer apareils.",
      "image":"reemploi_petit.png",
   ...
   },
   {
      ...
      "modesCollecte":"true",
      "descr":"Plusieurs organismes ('Lever l'encre' et 'Oce'encre' à Nantes, 'encre Station' à Saint-Herblain) récupèrent les anciennes cartouches d'encres.",
      "descr_en":"Several agencies ('Sunrise ink' and 'Oce'encre' in Nantes, Ink Station 'in Saint-Herblain) recover old cartridges encrest.",
      "image":"reemploi_petit.png",
   ...
   },
   {
      ...
      "modesCollecte":"true",
      "descr":"Plusieurs organismes ('Ateliers du Retz Emploi', 'La Ressourcerie de l'ïle', 'Emmaüs', 'Véti Frat', 'La Croix Rouge') récupèrent les anciens jouets.",
      "descr_en":"Several agencies ('Retz Employment Workshops', 'The Ressourcerie of the island', 'Emmaus', 'Veti Frat', 'The Red Cross') recover old toys.",
      "image":"reemploi_petit.png",
   ...
   },
   {
      ...
      "modesCollecte":"true",
      "descr":"Plusieurs organismes ('Emmaus', 'Secours Populaire', 'Retz'agir', 'Le comptoir du Solilab') récupèrent les anciens meubles.",
      "descr_en":"Several organizations (Emmaus' 'Secours Populaire', 'Retz'agir', 'The counter Solilab') recover antique furniture.",
      "image":"reemploi_petit.png",
   ...
   },
   {
      ...
      "modesCollecte":"true",
      "descr":"Plusieurs organismes ('Ding-Fring', 'Secours Populaire', ) récupèrent les vêtements.",
      "descr_en":"Several agencies ('Ding Fring', 'Secours Populaire') recover clothing.",
      "image":"reemploi_petit.png",
   ...
   },
   {
      ...
      "modesCollecte":"true",
      "descr":"Plusieurs organismes (associations...) récupèrent les anciens meubles.",
      "descr_en":"Several organizations (associations ...) recover the antique furniture.",
      "image":"reemploi_petit.png",
   ...
   },
   {
      ...
      "modesCollecte":"true",
      "descr":"Plusieurs organismes (associations ATAO Vélo, Place aux vélos, bikes Vélo Campus) récupèrent les anciens vélos.",
      "descr_en":"Several organizations (associations ATAO Vélo, Place aux vélos, bikes Vélo Campus) recover old bikes.",
      "image":"reemploi_petit.png",
