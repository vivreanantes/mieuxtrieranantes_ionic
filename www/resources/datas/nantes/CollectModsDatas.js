var _collectModsDatas = [{
		...
		"modesCollecte": "false",
		"descr_en": "You can put all transparent bottles (water, soda), milk bottles, bottle of oil (plastic) bottles (detergent, bleach, household cleaners ...) except those that contained toxic products (with . Red Cross) or flammable (flame red) <br/> should not put them in polystyrene trays, yoghurt pots, plastic bags of supermarket.",
		...
		"modesCollecte": "false",
		"descr": "On peut mettre : cartons, cartonnettes, enveloppes, feuilles, journaux, magazines, briques, <B>tous les types de plastique</B> (bouteilles eau soda huile, bouchons, flacons, pots de yaourt, pots de crème fraîche, barquettes, films plastique)</B>,  barquettes aluminium, canettes, boîtes de conserves, bombes aérosols.",
		"descr_en": "<IMG SRC='resources/images/bac_jaune_en_cours_mini.png' align='right' WIDTH='150px' /> You can put <BR/>: cartons, cardboards, envelopes, sheets, newspapers, magazines, bricks, <B> all types of plastics </b> (soda water bottles oil, corks, bottles, yogurt cups, cream jars, trays, plastic films) </b>, aluminum trays, cans, tins, aerosols.",
		...
		"modesCollecte": "false",
		"descr": "<IMG SRC='resources/images/bac_jaune_en_cours_mini.png' ALIGN='right' WIDTH='150px' /><BR/>On peut mettre : cartons, cartonnettes, enveloppes, feuilles, journaux, magazines, briques, les bouteilles eau soda huile, bouchons, flacons,  barquettes aluminium, canettes, boîtes de conserves, bombes aérosols.",
		...
		"modesCollecte": "false",
		"descr": "<IMG SRC='resources/images/nantes/sac_jaune_mini.png' ALIGN='right' WIDTH='150px' /><UL>On peut mettre : cartons, cartonnettes, enveloppes, feuilles, journaux, magazines, prospectus, boîtes à œuf en carton, briques, bouteilles avec bouchons (eau, soda, huile), flacons, barquettes aluminium, canettes, boîtes de conserves, bombes aérosols.",
		"descr_en": "<IMG SRC='resources/images/nantes/sac_jaune_mini.png' align='right' WIDTH='150px' /> <UL> You can put: cartons, cardboards, envelopes, sheets, newspapers, magazines, brochures, egg boxes cardboard, bricks, bottles with caps (water, soda, oil), bottles, aluminum trays, cans, tins, aerosols.",
		...
		"modesCollecte": "false",
		"descr": "Les Ecopoints sont des mini-déchèteries où seuls les gravats ne sont pas admis.<BR/>Les déchets suivants sont admis :encombrants, appareils électriques, déchets toxiques en petites quantités, déchets verts, bouteilles et flacons plastiques, papiers, cartons, cartonnettes, verre ménager (pôts, bouteilles), métal.",
		"descr_en": "The Ecopoints are mini-waste collection centers where only rubble are allowed <BR/> The following shall be permitted:. Bulky, electrical appliances, toxic waste in small quantities, green waste, plastic bottles, paper, cardboard, cardboards, glass household (Pots, bottles), metal.",
		"icone": "modco",
		...
		"modesCollecte": "true",
		"descr": "Depuis le 1er janvier 2015, il existe aussi le principe du « 1 pour 0 » : les magasins dont la surface de vente consacrée aux appareils électriques et électroniques est supérieure à 400m² doivent reprendre vos appareils de moins de 25cm de côté gratuitement et sans obligation d’achat. ",
		...
		"libelleBouton_en": "Takeover by stores",
		"modesCollecte": "true",
		"descr": "Pour certains biens (électroménager, meuble, matelas, pneu...), le distributeur est désormais tenu de reprendre l'ancien à l'achat ou la livraison. C'est le principe de la reprise 1 pour 1.",
		"descr_en": "You buy a new appliance, the distributor is now required to take the former for the purchase or delivery. This is the principle of the recovery 'one for one'.",
		"cons": "cons_ecopart",
		"image": "reemploi_petit.png",
		"mots_cles": "reprise,magasin",
